...
SECRET_KEY = 'django-insecure-0+w1teh(-+$!ur8b&xl9xaxu$-*%tzpegjzq0$(fl$mjoi0ij1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


ALLOWED_HOSTS = ['my-public-space.onrender.com']
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'templates',
            BASE_DIR / 'space/templates',  # Add this if you're not already including it
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
